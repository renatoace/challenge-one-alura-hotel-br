...
public class ReservasView extends JFrame {
		...
		btnProximo.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				if (ReservasView.txtDataE.getDate() != null && ReservasView.txtDataS.getDate() != null) {
					...
					if (ReservasView.txtDataS.getDate().after(ReservasView.txtDataE.getDate())) {
						
						Integer idReserva = salvar();// aqui estou salvando e recebendo o id da Reserva.
						...
						JOptionPane.showMessageDialog(null,
								"A Data de Check Out tem que ser maior do que a de Check In.");
					}
	...
	protected Integer salvar() {
		Reserva reserva = new Reserva(txtDataE.getDate(), txtDataS.getDate(), Double.parseDouble(txtValor.getText()),
