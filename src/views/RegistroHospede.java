...
public class RegistroHospede extends JFrame {
	...
	public RegistroHospede(Integer idReserva) {
		...
		btnsalvar.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				if (txtNome.getText() != null && txtNome.getText() != null && txtDataN.getDate() != null) {

					Reserva reserva = new Reserva();
					reserva.setId(idReserva);
					
					salvar(reserva);
					JOptionPane.showMessageDialog(null, "Reserva feita com sucesso, com número de reserva : "+txtNreserva.getText()+"  !!!!");
